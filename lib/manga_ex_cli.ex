defmodule MangaExCli do
  ...
  defp do_download_chapters(manga_url, chapter, manga_name, chapters_count) do
    ...
    |> do_download(manga_name, chapter, chapters_count)
  end

  defp do_download(pages, manga_name, chapter, chapters_count) do
    Mangahost.download_pages(pages, manga_name, chapter)
    |> case do
      result when result == [] ->
        :timer.sleep(:timer.seconds(1))
        do_download(pages, manga_name, chapter, chapters_count)
